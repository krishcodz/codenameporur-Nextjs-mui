  ...
  return (
    <Grid
      ...
      sx={{
        ...
        color: "white",
        padding: { xs: "40px 20px", md: "50px 250px" },
      }}
    >
      <Grid
        container
      ...
      >
        <Typography
          sx={{ fontSize: "28px", fontWeight: 500, lineHeight: "31px", pb: 2 }}
        >
          Experience
        </Typography>
        <Typography
          sx={{ color: "#FBB70F", fontSize: "25px", lineHeight: "15px", pb: 1 }}
        >
          Code Name
        </Typography>
        <Typography
          sx={{ color: "#FBB70F", fontSize: "25px", lineHeight: "15px", pb: 2 }}
        >
          Newporur
        </Typography>
        <Typography
